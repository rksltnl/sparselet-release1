...
extern "C"{
  void mkl_scscmm_(char* chn, ptrdiff_t* m, ptrdiff_t* n, ptrdiff_t* k, \
...
{  
  ...
  ptrdiff_t m = (ptrdiff_t)A_dims[0];
  ptrdiff_t k = (ptrdiff_t)A_dims[1];
  ptrdiff_t n = (ptrdiff_t)mxGetM(prhs[4]);
